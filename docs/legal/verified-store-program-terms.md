...
## 1. The Fee Is For Processing, Not A Purchase
The Verified Store application fee (currently Rs. 5,000, subject to
change) pays for the cost of reviewing your application. **It is not a
purchase of the Verified badge, and paying it does not guarantee
approval.** The fee is debited from your wallet at the moment you submit
your application, before any decision has been made.

## 2. Eligibility Is Not A Guarantee Of Approval
Before you may apply, your store must meet every published eligibility
criterion (currently: 6+ months continuous operation on the same verified
custom domain, a Store Health Score of 80+, CNIC verification on file,
...
## 3. Rejection Refunds The Fee
If your application is rejected, the application fee is refunded to your
wallet in full (current policy, subject to change and published in
advance of any change).

## 4. The Badge Is Revocable, Never Permanent
Verified status is not a one-time, permanent grant.
- If your Store Health Score drops below the required threshold, or a
...
time — this is never a rubber-stamp renewal. A separate re-verification
fee may apply (currently Rs. 0 / no additional fee, subject to change).

## 6. Where The Badge Appears
The Verified badge is shown on your storefront (every page) and at
checkout, for as long as your store's status is Verified, and disappears
